...
namespace Business.Services
{
    ...
    public class JwtService : IJwtService
    {
        ...
        /// <param name="appSettings">Configuraciones generales de la aplicaci�n</param>
        public JwtService(
        ...
        /// <summary>
        /// Genera un token JWT espec�fico para restablecer contrase�a.
        /// </summary>
        /// <param name="user">Usuario que solicita restablecer su contrase�a</param>
        /// <returns>Token JWT con tiempo de expiraci�n corto</returns>
        public string GeneratePasswordResetToken(User user)
        {
            // Usamos la implementaci�n subyacente en la capa de utilidades
